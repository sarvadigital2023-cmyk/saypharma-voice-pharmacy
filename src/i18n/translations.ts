...
export const messages: Record<Locale, Messages> = {
  ...
  uk: {
    ...
    "transcript.empty": "Натисніть «Поговорити з SayPharma» — і тут з'явиться текст вашої розмови.",
    "transcript.roleAgent": "Оператор",
    "transcript.roleUser": "Ви",
    "transcript.copy": "Скопіювати всю розмову",
    "transcript.copied": "Скопійовано",
    ...
    "trust.lead":
      "Працюємо лише із сертифікованими ліками. Рецептурні препарати потребують підтвердження. Розмови захищені наскрізним шифруванням.",
    "trust.i1": "Лише ліцензовані постачальники",
    "trust.i2": "Захист персональних даних за стандартами ЄС",
    ...
    "settings.info.privacy.body": [
      "Ми обробляємо ваші дані відповідно до GDPR. Розмови з ШІ-оператором захищені наскрізним шифруванням і використовуються лише для оформлення вашого замовлення.",
    ...
    "settings.info.warning.body": [
      ...
      "Для отримання рецептурних препаратів зверніться до нашої аптеки до провізора та пред'явіть рецепт від лікаря.",
  ...
  en: {
    ...
    "transcript.idle": "Offline",
    "transcript.empty": "Press “Talk to SayPharma” and your conversation will appear here.",
    "transcript.roleAgent": "Operator",
    "transcript.roleUser": "You",
    "transcript.copy": "Copy entire conversation",
    ...
    "trust.lead":
      "We work only with certified medicines. Prescription drugs require confirmation. Conversations are end-to-end encrypted.",
    "trust.i1": "Only licensed suppliers",
    "trust.i2": "Personal data protection to EU standards",
    ...
    "settings.info.privacy.body": [
      "We process your data in accordance with GDPR. Conversations with the AI operator are end-to-end encrypted and used only to fulfill your order.",
    ...
    "settings.info.warning.body": [
      ...
      "To obtain prescription drugs, please visit our pharmacy and present a prescription from your doctor.",
